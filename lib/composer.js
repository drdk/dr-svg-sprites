module.exports = function (config, callback) {
	...
	function composeSpriteElements () {
		...
		_.forOwn(config.sprites, function (spriteElements, spriteName) {
			...
			_.forOwn(spriteElements, function (spriteElement, fileName) {
				composeSpriteElement(destination, spriteElement, fileName);
			});
		});
	...
	function composeSpriteElement (destination, spriteElements, fileName) {
