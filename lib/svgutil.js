...
function wrap (width, height, shapes) {
	return '<svg baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" _width="' + width + '" _height="' + height + '" preserveAspectRatio="xMaxYMax meet" viewBox="0 0 ' + width + ' ' + height + '" >' + shapes.join("") + '</svg>';
}
